...
export const DashboardHome: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Suscripción a cambios en streaming_config para actualizar el dashboard en tiempo real
  ...
  return (
    <div className="space-y-10 animate-fadeIn min-h-screen relative">
      ...
      <div className="fixed top-0 -left-1/4 w-full h-full blur-[120px] rounded-full mix-blend-screen animate-blob bg-blue-600/20 transition-colors duration-1000"></div>
      <div className="fixed bottom-0 -right-1/4 w-full h-full blur-[120px] rounded-full mix-blend-screen animate-blob animation-delay-2000 bg-violet-600/20 transition-colors duration-1000"></div>
      ...
      <div className="glass-panel rounded-[2.5rem] p-10 relative overflow-hidden group transition-all duration-700">
        ...
        <div className="relative z-10 flex justify-between items-end">
          ...
          {/* ── BLOQUE DERECHO: SALADILLOVIVO + STREAMING STATUS ── */}
          <div className="hidden lg:flex flex-col items-end gap-4 text-right">
            ...
            <div className={`px-4 py-2 rounded-2xl border transition-all duration-500 flex flex-col items-end group/live ${isLive ? 'bg-red-500/10 border-red-500/50 shadow-[0_0_20px_rgba(239,68,68,0.1)]' : 'bg-slate-800/50 border-white/5'}`}>
               <div className="flex items-center gap-2">
                  <div className={`w-1.5 h-1.5 rounded-full ${isLive ? 'bg-red-500 animate-pulse' : 'bg-slate-600'}`}></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          {/* Quick Stats */}
          <div className="glass-card rounded-3xl p-6 relative overflow-hidden transition-all duration-700">
