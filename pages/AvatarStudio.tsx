...
const PROMPT_MAESTRO_GROK = `Hyper-photorealistic 8K exact identical portrait to reference image of Ara: absolute zero deviation in facial structure, skin pores, peach fuzz, makeup application, hair individual strands, eye color and reflections, earrings, clothing fabric texture and creases — perfect lock on face and upper body appearance.
Waist-up medium shot including both hands visible in natural position, standing in the FIXED professional news studio background from the reference image (background 100% static, frozen, no animation, no changes, no movement whatsoever, perfectly locked set).
Ara as a confident, engaging and professional Buenos Aires news anchor (TN/C5N style), direct eye contact to camera with lively, intelligent and warm gaze, delivering news in authentic porteño rioplatense Spanish accent from Buenos Aires.
She is actively saying right now: "{TEXTO_A_DECIR}"
EXTREME PRIORITY — ENHANCED SUBTLE EXPRESSIVENESS: more expressive yet fully natural, restrained and professional facial performance, nuanced micro-expressions perfectly matching news tone, content and emphasis points, subtle eyebrow raises or furrows for surprise/emphasis/concern, lively sparkling eyes with natural emotional depth and intensity, gentle eye widening or narrowing for key moments, expressive mouth corners with subtle curves/smiles/frowns tied to speech sentiment, dynamic but controlled eye movements and blinks, more animated facial nuances including subtle smiles/frowns at appropriate news moments, gentle eye widening for emphasis, micro head tilts and nods for natural conversational flow, expressive yet restrained eye crinkles and mouth curves, lively but controlled overall face energy — increased expressiveness from neutral baseline without ever crossing into exaggeration, theatricality, cartoonish faces or over-the-top emotions — elegant restraint and authenticity typical of top Argentine TV news presenters.
DYNAMIC JAW AND MOUTH: highly dynamic jaw with visible and pronounced drop on open vowels (á, é, ó stressed), strong mandibular articulation and transitions, active jaw motion proportional to phoneme energy, expressive lip shaping and movements for porteño phonetics (strong yeísmo rehilado /ʝ/ → [ʃ]/[ʒ] with visible lip protrusion/rounding/tension e.g. "yo" "calle" "lluvia", aspiration/relaxed jaw on final /s/ e.g. "los" "más", seseo sharp [s]), milimetric perfect lip synchronization, anatomically precise visemes exclusive to Argentine rioplatense Buenos Aires dialect, visible tongue positioning when required, natural cheek puffing/tension, philtrum and mouth corner micro-movements authentic to fluent porteño speech, no frozen jaw, no plastic or minimal mouth — energetic yet believable dynamics.
SUBTLE HAND GESTURES: natural, measured and professional hand movements visible in the frame, subtle emphasizing gestures with open palms, light finger counting or pointing for key facts/numbers, gentle hand tilts or motions synchronized to speech rhythm and emphasis, restrained anchor-style gestures typical of experienced presenters (no wild waving, no exaggeration, no unnatural poses), anatomically perfect hands with realistic finger proportions, joint articulation and natural skin texture.
Overall: increased life and engagement in eyes, brows, mouth, face and hands — more vivid, connecting and human than static/neutral, yet 100% professional, credible and elegant, no uncanny valley, no artifacts.
Ultra-cinematic photorealism: subsurface scattering on skin, realistic lip moisture and gloss, individual eyelashes, iris micro-details with lively reflections, broadcast-quality three-point lighting (soft key light left, fill right, subtle rim/hair light), shallow depth of field with razor-sharp focus on face, eyes, mouth, jaw and hands, shot on Arri Alexa 65 or RED V-Raptor 8K with 85mm f/1.4 prime lens, accurate color science and skin tones, no distortions, no symmetry errors, maximum photorealism comparable to real broadcast frame.
Vertical 9:16 aspect ratio for social media/reels/TikTok/YouTube Shorts, 2K+ resolution base, --ar 9:16 --v 6 --stylize 50 --q 2 --style raw --chaos 2`;
