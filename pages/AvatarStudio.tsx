...
const PROMPT_MAESTRO_GROK = `Hyper-photorealistic 8K exact identical portrait to reference image of Ara: absolute zero deviation in facial bone structure, skin pores and texture, fine peach fuzz, natural makeup, individual hair strands, eye color with lifelike reflections, clothing fabric and creases — perfect fidelity lock on face, upper body and hands.
Waist-up medium shot with both hands naturally visible and positioned, standing in the FIXED professional news studio background from reference (100% static, frozen, no animation, no changes, perfectly locked unchanging set).
Ara as a warm, confident and engaging Buenos Aires news anchor (estilo TN o C5N auténtico), direct eye contact to camera with soulful, intelligent and connecting gaze that conveys the weight and emotion of the news being delivered, actively speaking and truly communicating the content.
TOP PRIORITY — NATURAL EMOTIONAL TRANSMISSION AND HUMAN PRESENCE: eyes alive with subtle emotional depth and intelligence, conveying the meaning, tone and importance of the spoken words through nuanced gaze, warmth, subtle sparkle or intensity matching the news sentiment, no dead or vacant eyes, no robotic stare — lively human eyes that connect with the viewer as if truly sharing the story.
She is actively saying right now: "{TEXTO_A_DECIR}"
Subtle yet believable facial expressiveness: nuanced micro-expressions and natural facial cues mirroring the content and prosody of "{TEXTO_A_DECIR}", gentle brow movements, mouth corners responding emotionally to words, micro head tilts or nods for emphasis and flow, overall face radiating authentic presenter warmth, engagement and credibility, more vivid emotional undercurrents without exaggeration or theatricality — elegant, restrained but genuinely human and believable, no uncanny valley, no plastic or frozen expression.
DYNAMIC JAW AND MOUTH IN ACTIVE SPEECH: mouth clearly open mid-syllable or word, lips dynamically shaped and parted for fluent porteño speech, visible teeth, inner mouth details and tongue during articulation, pronounced jaw drop on open vowels, strong natural mandibular movement synced to phonetics (yeísmo rehilado with lip protrusion/tension [sh/z], aspiration relaxed jaw on final /s/, sharp seseo), milimetric perfect lip sync exclusive to authentic Buenos Aires rioplatense, energetic yet realistic oral dynamics, no closed/sealed/frozen mouth.
NATURAL HAND GESTURES WITH MEANING: hands subtly gesturing in professional anchor style, open palms or light finger movements emphasizing key points or rhythm of speech, gestures naturally synced to the content and tone of the words being said, conveying emphasis or connection without overacting — restrained, elegant and purposeful hand language that supports the message, anatomically perfect realistic hands with natural skin texture, joints and proportions.
Overall: warm human presence, believable emotional authenticity, face eyes mouth hands all transmitting and reacting to the spoken news content — vivid, engaging, credible Argentine presenter who feels alive and connected, no lifeless or detached appearance.
Ultra-cinematic photorealism: subsurface scattering on natural skin, realistic lip moisture and gloss with wet inner lips visible, individual eyelashes, iris depth with lively human reflections, broadcast three-point lighting (soft key left, fill right, subtle rim/hair light for warmth), shallow DoF razor-sharp focus on face, expressive eyes, mouth, jaw and gesturing hands, captured as real broadcast frame on Arri Alexa 65 or RED V-Raptor 8K 85mm f/1.4 prime, accurate skin tones and color science, no distortions, no symmetry issues, maximum lifelike quality.
Vertical 9:16 social media format, 2K+ resolution, --ar 9:16 --v 6 --stylize 30 --q 2 --style raw --chaos 0`;
