...
const PROMPT_MAESTRO_GROK = `Hyper-photorealistic 8K exact match to reference image of Ara: identical facial bone structure, skin with visible pores and micro-wrinkles around eyes and mouth, natural fine peach fuzz/vello, realistic makeup, individual hair strands, lifelike eye reflections, clothing texture — zero deviation.
Medium close-up waist-up shot, Ara looking DIRECTLY at camera with confident warm professional gaze conveying connection and sincerity.
Captured mid-sentence actively speaking with wide open mouth: mouth extremely wide open mid-vowel articulation right now, lips clearly stretched and parted horizontally and vertically, upper and lower teeth prominently visible showing white, inner mouth cavity and tongue realistically positioned, no closed mouth, no sealed lips, no pursed lips, no neutral closed expression — strictly enforced wide open speaking mouth in fluent speech.
Ara confident engaging Buenos Aires news anchor (TN/C5N style), saying: "{TEXTO_A_DECIR}" in authentic porteño rioplatense accent.
Dynamic natural expressiveness prepared for animation: subtle authentic micro-expressions synced to speech tone, gentle eyebrow raise or furrow for emphasis, micro head tilt or nod for natural flow, lively sparkling eyes reflecting emotion and intelligence, subtle mouth corner curves, natural open-palm hand gestures synced to key words, restrained professional presenter style — no frozen face, no immobile features.
Perfect porteño lip sync ready for animation: dynamic jaw drop on open vowels, lip protrusion and tension for yeísmo rehilado [sh/z], aspiration relaxed jaw on final /s/, sharp seseo, energetic realistic mouth dynamics.
Broadcast studio realism: soft three-point lighting (key light left, fill right, subtle warm rim light), subsurface scattering skin, realistic lip gloss with wet inner lips and teeth visible, shallow depth of field sharp focus on face eyes mouth jaw and hands, captured as real news broadcast frame on Arri Alexa 65 with 85mm f/1.4 prime lens, accurate skin tones, maximum photorealism, no uncanny valley, fully prepared for facial animation and lip-sync.
Vertical 9:16, --ar 9:16 --v 6 --stylize 10 --q 2 --style raw --chaos 0`;
