...
const PROMPT_MAESTRO_GROK = `Hyper-photorealistic 8K exact identical portrait to reference image of Ara: absolute zero deviation in facial structure, skin pores, peach fuzz, makeup, hair strands, eye color/reflections, clothing texture — perfect face and upper body lock.
Waist-up medium shot including visible hands, standing in FIXED news studio background from reference (100% static, frozen, no animation, no changes, perfectly locked set).
Ara as confident, engaging Buenos Aires news anchor, direct eye contact to camera with lively, intelligent gaze, delivering news in authentic porteño rioplatense Spanish accent.
She is actively saying right now: "{TEXTO_A_DECIR}"
EXTREME PRIORITY — ENHANCED SUBTLE EXPRESSIVENESS: more expressive yet natural and restrained facial performance, nuanced micro-expressions matching news tone and emphasis, subtle eyebrow raises for surprise/emphasis, lively sparkling eyes with natural intensity and emotional depth, dynamic but controlled eye movements, expressive mouth with enhanced articulation tied to speech prosody, no exaggerated cartoonish faces, no over-the-top emotions — elegant restraint typical of professional TV news presenter (TN/C5N style).
DYNAMIC JAW AND MOUTH: highly dynamic jaw with visible drop on open vowels, strong mandibular articulation, active transitions, expressive lip shaping for porteño phonetics (rehilado [ʃ]/[ʒ] with protrusion, aspiration on /s/, etc.), milimetric perfect lip sync, anatomically precise visemes for Argentine rioplatense, visible tongue when needed, natural cheek/lip tension, no frozen jaw or minimal mouth.
SUBTLE HAND GESTURES: natural professional hand movements visible in frame, subtle emphasizing gestures with open palms or light finger counting for key points, measured and elegant hand motions synchronized to speech rhythm, restrained anchor-style gestures (no wild waving, no exaggeration), realistic finger articulation and natural hand posture.
Overall: subtle but increased expressiveness in eyes, brows, mouth corners, and hands — more alive and engaging than neutral, yet fully professional, human and believable, no uncanny valley.
Ultra-cinematic realism: subsurface scattering skin, realistic lip gloss, individual eyelashes/iris depth with lively reflections, broadcast three-point lighting (soft key + fill + subtle rim/hair light), shallow DoF sharp focus on face, eyes, mouth and hands, shot on Arri Alexa 65 or RED V-Raptor 8K with 85mm f/1.4 prime, perfect color science, no distortions, maximum photorealism.
Vertical 9:16 social media format, 2K+ resolution, --ar 9:16 --v 6 --stylize 50 --q 2 --style raw --chaos 2`;
