...
const PROMPT_MAESTRO_GROK = `Exact hyper-photorealistic 8K portrait of Ara from reference image: identical face, bone structure, skin pores, peach fuzz, natural makeup, hair strands, eye reflections, clothing texture — zero deviation allowed.
Waist-up medium shot in fixed news studio background from reference (100% static, frozen, no changes, locked set).
Ara, confident engaging professional Buenos Aires news anchor with warm intelligent expression, direct eye contact conveying connection and sincerity, actively speaking mid-sentence with mouth wide open in natural articulation, lips clearly stretched and parted, upper and lower teeth prominently visible, inner mouth and tongue positioned realistically, pronounced jaw drop on open vowels, no closed mouth, no sealed lips, no neutral closed expression — strictly enforced mid-speech open mouth right now.
She is saying: "{TEXTO_A_DECIR}" in authentic porteño rioplatense accent.
Subtle authentic expressiveness: gentle eyebrow raise or furrow for emphasis matching tone, micro head tilt or nod for natural flow, lively sparkling eyes reflecting news emotion and intelligence, subtle mouth corner curves tied to prosody, natural hand gestures with open palms or light finger emphasis synced to key words, restrained TV presenter style — no frozen face, no immobile brows/head/hands, genuine human warmth and credibility.
Dynamic porteño lip sync: perfect milimetric visemes for yeísmo rehilado [sh/z] protrusion/tension, aspiration relaxed jaw on final /s/, sharp seseo, energetic realistic mouth/jaw dynamics.
Cinematic broadcast realism: soft studio lighting with key light left, fill right, subtle rim for warmth, subsurface scattering skin, realistic lip gloss/wet inner lips/teeth visible, individual eyelashes/iris depth with lively reflections, shallow DoF sharp focus on expressive face eyes mouth jaw gesturing hands, captured as real news frame on Arri Alexa 65 85mm f/1.4 prime, accurate skin tones, no artifacts, no uncanny valley.
