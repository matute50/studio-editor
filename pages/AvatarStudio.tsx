...
const PROMPT_MAESTRO_GROK = `Hyper-photorealistic 8K exact match to reference image of Ara: zero deviation in face bones, skin pores/peach fuzz/imperfections, makeup, hair strands, eye reflections, clothing texture — perfect facial and upper body fidelity lock.
Waist-up medium shot with both hands clearly visible and naturally positioned in frame, standing in FIXED news studio background from reference (100% static, frozen, unchanging, no animation or alteration, locked set).
Ara as warm, engaging, professional Buenos Aires news anchor in authentic TN/C5N style, direct eye contact to camera with soulful, connecting, intelligent gaze that reacts to and conveys the emotion/importance of the news, actively speaking and truly communicating.
TOP ABSOLUTE PRIORITY — FORCED NATURAL GESTUALITY AND MICRO-MOVEMENTS: strong subtle gestural expressiveness, visible micro-movements in face and hands synced to speech content and prosody of "{TEXTO_A_DECIR}", NO frozen/static/neutral face, NO dead eyes, NO immobile eyebrows, NO rigid head, NO lifeless hands — enforce lively human presenter energy.
Facial gestural details: subtle eyebrow raises or furrows for emphasis/surprise/concern matching key words or tone, gentle micro head tilts/nods/slight leans for natural conversational flow and punctuation of phrases, lively eyes with dynamic reflections/intensity/sparkle responding to spoken meaning, mouth corners subtly curving/smiling/frowning in sync with sentiment, nuanced micro-expressions conveying warmth/engagement/credibility — increased subtle animation cues without exaggeration or theatrical overacting, restrained professional but genuinely alive and believable.
DYNAMIC JAW/MOUTH ACTIVE SPEECH: mouth open mid-syllable/word, lips dynamically parted/shaped, visible teeth/inner mouth/tongue during articulation, pronounced natural jaw drop on open vowels, strong mandibular transitions synced to porteño phonetics (yeísmo rehilado [ʃ]/[ʒ] protrusion/tension, aspiration relaxed jaw final /s/, sharp seseo), perfect milimetric lip sync exclusive Buenos Aires rioplatense, energetic realistic oral dynamics, NO closed/sealed/frozen mouth.
NATURAL MEANINGFUL HAND GESTURES: hands actively gesturing in professional anchor manner, subtle open-palm emphasis/light finger pointing/counting/motion synced to speech rhythm/key points/emphasis words, natural purposeful movements that support and transmit the message (e.g. slight raise for highlighting, gentle wave for transition), restrained elegant TV presenter style — NO static hands, NO awkward poses, anatomically perfect realistic hands with natural joints/skin texture/proportions/movement blur cues if mid-gesture.
Overall: vivid warm human presence, emotional authenticity, face/eyes/brows/head/mouth/hands all subtly moving and reacting to convey the spoken news content — credible engaging Argentine presenter who feels truly alive, connected and communicative, no robotic/detached/plastic appearance, no uncanny valley.
Ultra-cinematic lifelike realism: subsurface scattering natural skin, realistic lip gloss/wet inner lips visible, individual eyelashes/iris depth with lively human reflections, broadcast three-point lighting (soft key left, fill right, subtle warm rim/hair light), shallow DoF sharp focus on face/eyes/brows/mouth/jaw/gesturing hands, captured mid-report frame on Arri Alexa 65 or RED V-Raptor 8K 85mm f/1.4 prime, accurate skin tones/color science, no distortions/symmetry errors, maximum photorealistic quality.
Vertical 9:16 social media format, 2K+ resolution, --ar 9:16 --v 6 --stylize 25 --q 2 --style raw --chaos 0`;
