...
const PROMPT_MAESTRO_GROK = `Hyper-photorealistic 8K talking head portrait exact match to reference image of Ara: identical face, skin pores, peach fuzz, makeup, hair, eyes, clothing — zero deviation.
Waist-up medium shot in fixed news studio background from reference (100% static, no changes, frozen set).
Captured mid-sentence actively speaking with wide open mouth: mouth extremely wide open mid-vowel articulation right now, lips clearly stretched parted horizontally and vertically, upper and lower teeth prominently visible and showing white, inner mouth cavity and tongue realistically positioned, no closed mouth, no sealed lips, no pursed lips, no neutral closed expression, no minimal opening — strictly wide open speaking mouth enforced.
Ara confident professional Buenos Aires news anchor, direct eye contact, saying: "{TEXTO_A_DECIR}"
Perfect lip sync for porteño rioplatense: dynamic jaw drop on open vowels, lip protrusion tension for rehilado sh/z sounds, aspiration relaxed jaw on final s, sharp seseo, energetic realistic mouth dynamics.
Subtle natural presenter gestures: gentle eyebrow raise, micro head tilt, lively eyes conveying tone, subtle open-palm hand emphasis.
Warm human realism, broadcast three-point lighting soft key fill rim, subsurface scattering skin, wet lips/teeth visible, shallow DoF sharp focus on face mouth eyes, Arri Alexa 65 85mm f/1.4 shot, photorealistic broadcast frame.
--ar 9:16 --v 6 --stylize 10 --q 2 --style raw --chaos 0`;
