...
const PROMPT_MAESTRO_GROK = `Hyper-photorealistic 8K exact identical portrait match to the attached reference image of Ara: zero deviation allowed in facial anatomy, bone structure, skin pores/peach fuzz/imperfections, natural makeup, hair strands detail, eye color/lifelike reflections, clothing fabric/creases — perfect lock on face, upper body and hands from reference.
Waist-up medium shot with both hands naturally visible and positioned as a news presenter, standing in the FIXED professional news studio background from reference (100% static, frozen, no animation, no changes, perfectly locked unchanging set).
TOP ABSOLUTE PRIORITY — MUST BE ACTIVELY SPEAKING WITH OPEN MOUTH: captured mid-sentence in full fluent speech, mouth clearly open and dynamically articulating right now, lips parted and shaped mid-word or mid-syllable, visible upper and lower teeth, inner mouth cavity details, tongue visible and positioned correctly during phoneme, no closed mouth under any circumstances, no sealed lips, no pursed lips, no neutral closed expression, no minimal mouth opening — enforced open mouth in active Argentine Spanish speech.
Ara as confident warm engaging Buenos Aires news anchor (TN/C5N authentic style), direct eye contact to camera with soulful intelligent connecting gaze conveying the news emotion, actively presenting and communicating.
She is saying right now: "{TEXTO_A_DECIR}"
DYNAMIC JAW AND MOUTH ENFORCEMENT: highly dynamic pronounced jaw drop and vertical opening especially on open vowels (á é ó stressed), strong natural mandibular articulation and transitions, expressive lip shaping/protrusion/tension for porteño rioplatense phonetics (yeísmo rehilado /ʝ/ → [ʃ]/[ʒ] sh/z sounds with forward lip rounding and narrowing, aspiration/relaxed jaw drop on final /s/ e.g. los → loh, sharp seseo alveolar [s]), milimetric perfect lip synchronization anatomically accurate for Buenos Aires dialect only, visible tongue elevation/retroflex for rehilado, cheek/lip tension authentic to fluent speech, energetic realistic oral dynamics, NO frozen/static/closed/sealed mouth or jaw.
ENHANCED SUBTLE GESTUALITY: subtle micro-movements synced to speech — gentle eyebrow raises/furrows for emphasis/surprise/concern, micro head tilts/nods/leans for natural flow, lively eyes with intensity/sparkle reflecting tone, mouth corners subtly curving in sentiment sync, natural professional hand gestures (open palms/light finger emphasis/counting synced to key words/rhythm), restrained TV anchor style without wild motion — NO immobile face/brows/head/hands, NO lifeless appearance.
Overall: vivid credible human presenter radiating warmth engagement and authenticity, face eyes brows mouth jaw hands subtly reacting to and transmitting the spoken content, no robotic/plastic/uncanny valley.
Ultra-lifelike cinematic realism: subsurface scattering natural skin, realistic lip moisture/gloss with wet inner lips/teeth visible, individual eyelashes/iris depth with human reflections, broadcast three-point lighting (soft key left, fill right, subtle warm rim/hair light), shallow DoF razor-sharp focus on expressive face eyes mouth jaw gesturing hands, real broadcast frame shot on Arri Alexa 65 or RED V-Raptor 8K 85mm f/1.4 prime, accurate skin tones/colors, no distortions/symmetry errors, maximum photorealism.
Vertical 9:16 social media format, 2K+ resolution, --ar 9:16 --v 6 --stylize 20 --q 2 --style raw --chaos 0`;
