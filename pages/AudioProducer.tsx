...
export const AudioProducer: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const speechResult = await generateSpeech(scriptWithSlogan, selectedVoice, 'medio', manualSpeed, `${masterAiPrompt} ${solemnPrompt} ${vibePrompt} ${tempPrompt}`);
      ...
      setError(`Error de producción: ${err.message}`); 
      setIsGeneratingAudio(false); 
    }
  };
